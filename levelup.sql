...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 07 2013 г., 15:08
...
--
ALTER TABLE `groups`
  ADD CONSTRAINT `groups_ibfk_2` FOREIGN KEY (`id`) REFERENCES `students` (`idGroup`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `schedule`
  ...
  ADD CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`idClassroom`) REFERENCES `classrum` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
